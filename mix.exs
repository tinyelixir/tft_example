defmodule TftExample.MixProject do
  use Mix.Project
  ...
  defp deps do
    [
      ...
      {:scenic_driver_fb_tft, "~> 0.11", github: "tinyelixir/scenic_driver_fb_tft", branch: "0.11", targets: @all_targets},
